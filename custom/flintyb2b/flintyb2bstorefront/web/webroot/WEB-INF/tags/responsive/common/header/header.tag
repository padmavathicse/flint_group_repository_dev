	...
	<nav class="navigation navigation--top hidden-xs hidden-sm">
		<div class="row">
			<!-- <div class="col-sm-12 col-md-4">
				...
				<div class="nav__left js-site-logo" style="float:right;">
					<cms:pageSlot position="SiteLogo" var="logo" limit="1">
						<cms:component component="${logo}" element="div" class="yComponentWrapper"/>
					</cms:pageSlot>
				</div>
			...
			<div class="col-sm-4 col-md-4">
				<div class="nav__right ">
					<ul class="nav__links nav__links--account links-profile">
				...
				<div class="nav__right col-xs-6 col-xs-6 hidden-xs">
					<ul class="nav__links nav__links--shop_info">
						<li>
							<!-- <c:if test="${empty hideHeaderLinks}">
								<ycommerce:testId code="header_StoreFinder_link">
									<div class="nav-location hidden-xs hidden-sm hidden-lg hidden-md">
							...
							<div class="header-lang-drop"> <select name="code" id="lang-selector" class="form-control">
								
								<option value="en" selected="selected" lang="en">English</option>
								<option value="zh" lang="zh">
										中文</option>
								<option value="ja" lang="ja" disabled>
										日本語</option>
								<option value="de" lang="de" disabled>
										Deutsch</option>
